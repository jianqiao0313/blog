...
![image](https://static.xiaogezi.fun/images/ntfs-centos/1.png)

2. centos镜像（放在ISO文件夹下,我下载的是minimal版）

![image](https://static.xiaogezi.fun/images/ntfs-centos/2.png)

![image](https://static.xiaogezi.fun/images/ntfs-centos/3.png)
...
![image](https://static.xiaogezi.fun/images/ntfs-centos/6.png)

### 获取硬盘编号。在安装centos的时候，在Install Centos选项上，按下TAB，然后修改屏幕下面的命令为vmlinuz initrd=initrd.img linux dd quiet（图示2）

![image](https://static.xiaogezi.fun/images/ntfs-centos/7.png)

### 查看刚才分区的编号，为sda1，如下图，记住后然后重启

![image](https://static.xiaogezi.fun/images/ntfs-centos/5.png)
